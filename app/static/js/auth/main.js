    ...
    touchEnd(e) {
        ...
        if(this.points.length > 1) {
            ...
            */
            ...
            gesture_login(this.points);
            this.points = [];
            this.draw();
        }
    }
}
function gesture_login(gesture_array){
    $.ajax({
            type: "POST",
            data:{
                "gesture_array": JSON.stringify(gesture_array)
            },
            url: '/auth/login/gesture',
...
$(document).ready(function () {
    ...
    $('#basic_tab').toggleClass('active');
    $('#gesture_login').css('display','none');

    $('#basic_tab').click(function() {
        $(this).toggleClass('active');
        $('#gesture_tab').removeClass('active');
        $('#gesture_login').css('display','none');
    ...
    $('#gesture_tab').click(function() {
        ...
        $('#gesture_login').css('display','block');
